...
double calc_border(const double *prev_func, double *curr_func, const double *up_border_layer, const double *down_border_layer,
...
int main(int argc, char **argv) {
    ...
    do {
        ...
        // Calculate center
        tmp_max_diff = calc_center(prev_func, curr_func, layer_heights[proc_rank], offsets[proc_rank]);
        ...
        // Calculate border
        proc_max_diff = calc_border(prev_func, curr_func, up_border_layer, down_border_layer,
